...
export function VerifiedBadge({
  ...
  size = 16,
  className,
  "aria-label": ariaLabel = "Verificado",
  style,
  ...props
}: VerifiedBadgeProps) {
  return (
    <span
      ...
      className={cn(
        // Mudado do azul padrão para o roxo da nossa paleta (ex: text-purple-600)
        "relative inline-flex items-center justify-center align-middle text-purple-600 shrink-0",
        className
      )}
      role="img"
