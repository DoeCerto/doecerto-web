...
export function WhatIsDoeCerto() {
  ...
  return (
    <section ref={sectionRef} id="whatisdoecerto" className="pt-16 sm:pt-24 md:pt-32 pb-24 md:pb-48 bg-white text-gray-900 overflow-hidden rounded-b-[] relative z-20 shadow-xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="font-poppins text-base md:text-xl text-gray-600 space-y-4 md:space-y-6 text-center lg:text-left">
              <p className="leading-relaxed font-light">
                Mais do que uma plataforma, somos a <span className="font-medium text-black">conexão segura</span> entre quem deseja ajudar e projetos que realmente transformam vidas. Reunimos exclusivamente <span className="font-medium text-black">ONGs rigorosamente auditadas</span>, eliminando a burocracia e o risco de fraudes para que o seu foco seja apenas um: fazer o bem.
              </p>
              <p className="leading-relaxed font-light">
                Construímos um ambiente de confiança para facilitar a sua doação. Com tecnologia de ponta, <span className="font-medium text-black">verificação contínua</span> e <span className="font-medium text-black">total transparência</span>, você tem a certeza absoluta de que cada centavo chegará ao destino certo.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 mt-8 lg:mt-0">
            ...
            <div className="relative w-full h-[300px] sm:h-[400px] lg:h-[550px] rounded-3xl lg:rounded-[2rem] overflow-hidden shadow-2xl">
              <img src="/whatisdoecerto.jpeg" alt="Whatisdoecerto" className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
            </div>
          </div>
